        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          {values.map((v, i) => (
            <motion.div
              ...
              custom={i * 0.1}
              whileHover={{ y: -6 }}
              className={`group p-8 rounded-sm border border-outline-variant inner-highlight transition-all duration-300 hover:border-primary/40 cursor-pointer ${
            ...
            >
              ...
              <div className="w-12 h-12 rounded-sm bg-primary/10 flex items-center justify-center text-primary mb-5 group-hover:scale-110 transition-transform">
                {v.icon}
              </div>
