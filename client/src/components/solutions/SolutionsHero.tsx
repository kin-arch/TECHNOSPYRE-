        ...
        >
          ...
          <div className="max-w-xl">
            <motion.div variants={itemVars} className="mb-6">
              <span className="px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold tracking-widest uppercase flex items-center gap-2 w-fit">
                <Sparkles size={14} />
